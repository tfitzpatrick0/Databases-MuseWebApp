...
function searchArtist(param, t) {
    callApi("GET", SEARCH + "?q=" + param + "&type=" + t, null, handleSearchArtist)
}
...
function searchAlbum(param, t) {
    callApi("GET", SEARCH + "?q=" + param + "&type=" + t, null, handleSearchAlbum)
}
...
function playFromPL() { // play song from playlist
    let album_id = document.getElementById("albumId").value;
    let song_id = document.getElementById("songId").value;
    let song_index = 0;
